...
import tp.upload.domain.Item;
import tp.upload.domain.ItemRepository;
import tp.upload.domain.UploadFile;
import tp.upload.file.FileStore;
...
public class ItemController {
    ...
    public ResponseEntity<Resource> downloadAttach(@PathVariable Long itemId) throws MalformedURLException {
        ...
        String storeFileName = item.getAttachFile().getSystemFileName();
